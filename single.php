    ...
    <article>
      ...
      <aside class="col">
        ...
        <ul class="share-buttons row">
          <li>
            <a class="facebook-share" href="https://facebook.com/sharer.php?u=<?php the_permalink(); ?>?utm_medium=sharefromsite&utm_source=jumpkick_facebook" title="Share to Facebook" target="_blank">
          ...
          <li>
            <a class="twitter-share" href="https://twitter.com/share?text=<?php the_title(); ?>&url=<?php the_permalink(); ?>?utm_medium=sharefromsite&utm_source=jumpkick_twitter" title="Share to Twitter" target="_blank">
              <div class="icon-container">
          ...
          <li>
            <a class="email-share" href="mailto:?subject=<?php the_title(); ?>&body=<?php the_permalink(); ?>?utm_medium=sharefromsite&utm_source=jumpkick_email" title="Share via Email" target="_blank">
              <div class="icon-container">
